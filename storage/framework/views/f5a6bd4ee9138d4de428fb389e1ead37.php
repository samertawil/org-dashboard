...
<?php echo e($heading ?? 'Roles List'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
<?php echo e($subheading ?? 'Details for your Roles below.'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['href' => ''.e(route('role.create')).'','wire:navigate' => true,'variant' => 'primary','icon' => 'list-bullet']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('role.create')).'','wire:navigate' => true,'variant' => 'primary','icon' => 'list-bullet']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['wire:model.live.debounce.300ms' => 'search','label' => __('Search by ability Name'),'type' => 'text','placeholder' => __('Search ability name...'),'icon' => 'magnifying-glass']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live.debounce.300ms' => 'search','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search by ability Name')),'type' => 'text','placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search ability name...')),'icon' => 'magnifying-glass']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <div class="px-6 py-4 border-b border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900">
                    <div class="flex items-center justify-between">
                        <p class="text-sm text-zinc-600 dark:text-zinc-400 py-2">
                            ...
                            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($roles->firstItem()); ?></span>
                            <?php echo e(__('to')); ?>

                            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($roles->lastItem()); ?></span>
                            <?php echo e(__('of')); ?>

                            <span class="font-medium text-zinc-900 dark:text-white"><?php echo e($roles->total()); ?></span>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full divide-y divide-zinc-200 dark:divide-zinc-700">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortBy === 'name'): ?>
                                            <svg class="size-3" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                ...
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M<?php echo e($sortDir === 'asc' ? '4.5 15.75l7.5-7.5 7.5 7.5' : '19.5 8.25l-7.5 7.5-7.5-7.5'); ?>" />
                                            </svg>
                                        <?php else: ?>
                        ...
                        <tbody class="bg-white dark:bg-zinc-800 divide-y divide-zinc-200 dark:divide-zinc-700">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap text-sm text-zinc-600 dark:text-zinc-300">
                                        <?php echo e($role->created_at->format('Y-m-d H:i:s')); ?>

                                    </td>
                                    <td class="px-6 py-3 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                           
                                            <a href="<?php echo e(route('role.edit', $role->id)); ?>" wire:navigate
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-indigo-900 dark:text-indigo-200 dark:hover:bg-indigo-800">
                                            ...
                                            <button wire:click="destroy(<?php echo e($role->id); ?>)"
                                                wire:confirm="<?php echo e(__('customTrans.confirm delete')); ?>"
        ...
        <?php else: ?>
            ...
            <div
                ...
                <p class="text-sm text-zinc-500 dark:text-zinc-400 text-center mb-6 max-w-sm">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search): ?>
                        <?php echo e(__('No roles match your search criteria. Try adjusting your filters.')); ?>

                    <?php else: ?>
                        <p class="text-sm text-zinc-500 dark:text-zinc-400 text-center mb-6 max-w-sm">
                            <?php echo e(__('Get started by creating your first role.')); ?>
...
</div><?php /**PATH C:\xampp\htdocs\feras\org-dashboard\resources\views/livewire/app-setting/role/index.blade.php ENDPATH**/ ?>