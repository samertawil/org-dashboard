...
<ui-label <?php echo e($attributes->class($classes)); ?> data-flux-label>
    ...
    <span class="ms-1.5 text-xs px-1.5 py-1 -my-1 rounded-[4px]  bg-zinc-800/5 dark:bg-white/10 dark:text-zinc-300 <?php echo e($badgeColor ?? 'text-zinc-800/70'); ?>" aria-hidden="true">
            <?php echo e($badge); ?>
...
<?php /**PATH C:\xampp\htdocs\feras\org-dashboard\resources\views/flux/label.blade.php ENDPATH**/ ?>