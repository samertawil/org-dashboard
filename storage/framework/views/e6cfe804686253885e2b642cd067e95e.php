...
<?php endif; ?>
            ...
            <input
                ...
                <?php echo e($attributes->merge(['style' => 'height:auto'])->except('class')->class($type === 'file' ? '' : $classes)); ?>
...
<?php endif; ?>
<?php else: ?>
    <button  <?php echo e($attributes->merge(['type' => 'button', 'style' => 'height:auto'])->class([$classes, 'w-full relative flex'])); ?>>
        <?php if (is_string($iconLeading)): ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\feras\org-dashboard\resources\views/flux/input/index.blade.php ENDPATH**/ ?>