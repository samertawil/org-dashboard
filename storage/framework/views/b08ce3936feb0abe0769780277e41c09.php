...
<?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['displacement.camps.index', 'displacement.camps.create', 'camps.residents.index','activity.beneficiaries.index'])): ?>
                    <?php if (isset($component)) { $__componentOriginal31257750338e37e989bcfa8eb3c88bb1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal31257750338e37e989bcfa8eb3c88bb1 = $attributes; } ?>
...
<?php endif; ?>
                <?php endif; ?>
                 ...
                 <!-- Survey Group -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['survey.index', 'survey.create'])): ?>
                <?php if (isset($component)) { $__componentOriginal31257750338e37e989bcfa8eb3c88bb1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal31257750338e37e989bcfa8eb3c88bb1 = $attributes; } ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'clipboard-document-check','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('survey-answers.index')),'current' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('survey-answers.index')),'wire:navigate' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

                            <?php echo e(__('Survey Answers')); ?>
