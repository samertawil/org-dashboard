<div x-data="activityComments"
     data-users='<?php echo json_encode($mentionableUsers, 15, 512) ?>'>
    ...
    <div class="space-y-3 max-h-80 overflow-y-auto pr-1">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('comment-{{ $comment->id }}', get_defined_vars()); ?>wire:key="comment-<?php echo e($comment->id); ?>" class="flex gap-3 group">
                <div class="flex-shrink-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comment->creator?->google_id && $comment->creator?->avatar): ?>
                        <img src="<?php echo e($comment->creator->avatar); ?>" class="w-8 h-8 rounded-full object-cover" alt="<?php echo e($comment->creator->name); ?>">
                    <?php else: ?>
                    ...
                    <div class="bg-zinc-50 dark:bg-zinc-700/50 rounded-xl rounded-tl-none px-4 py-2.5 relative">
                        <div class="flex items-center justify-between gap-2 mb-1">
                            <span class="text-xs font-semibold text-zinc-700 dark:text-zinc-200">
                                <?php echo e($comment->creator?->name ?? __('Unknown')); ?>
                        ...
                        <p class="text-sm text-zinc-700 dark:text-zinc-300 break-words">
                            <?php echo preg_replace('/@([\w\s]+?)(?=\s|$|@)/u',
                                '<span class="text-indigo-600 dark:text-indigo-400 font-semibold">@$1</span>',
                                e($comment->comment)); ?>

                        </p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comment->created_by === auth()->id()): ?>
                            <button wire:click="deleteComment(<?php echo e($comment->id); ?>)"
                                wire:confirm="<?php echo e(__('Delete this comment?')); ?>"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            <p class="text-center text-xs text-zinc-400 py-4"><?php echo e(__('No comments yet. Be the first!')); ?></p>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
        ...
        <div class="flex gap-2 items-end">
            <div class="flex-shrink-0 mb-1">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->google_id && auth()->user()->avatar): ?>
                    <img src="<?php echo e(auth()->user()->avatar); ?>" class="w-8 h-8 rounded-full object-cover" alt="">
                <?php else: ?>
                    <div class="w-8 h-8 rounded-full bg-indigo-100 dark:bg-indigo-900/40 flex items-center justify-center text-xs font-bold text-indigo-600 dark:text-indigo-300">
            ...
            <div class="flex-1 relative">
                <textarea
                    ...
                    rows="2"
                    placeholder="<?php echo e(__('Write a comment… type @ to mention someone')); ?>"
                ...
                <div x-show="showDropdown"
                    ...
                    <div x-show="showDropdown"
                        ...
                        <div class="flex items-center justify-between px-5 py-3 border-b border-zinc-100 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50">
                            <span class="text-sm font-semibold text-zinc-800 dark:text-zinc-200"><?php echo e(__('Select a team member')); ?></span>
                        ...
                        <div class="max-h-[50vh] overflow-y-auto py-2">
                            ...
                            <div x-show="filteredUsers.length === 0" class="px-5 py-8 text-center flex flex-col items-center gap-2">
                                ...
                                <p class="text-sm text-zinc-500"><?php echo e(__('No users found matching:')); ?></p>
...
Alpine.data('activityComments', () => ({
    ...
    ?>
<?php /**PATH C:\xampp\htdocs\feras\org-dashboard\resources\views/livewire/org-app/activity/comments.blade.php ENDPATH**/ ?>