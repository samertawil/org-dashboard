<x-layouts::auth>
    <div class="flex flex-col gap-6">
        ...
        <form x-data="{ loading: false }" @submit="loading = true" method="POST" action="{{ route('login.store') }}" class="flex flex-col gap-6">
            @csrf
            ...
            <div class="flex items-center justify-end">
                <flux:button variant="primary" type="submit" class="w-full" data-test="login-button" ::disabled="loading">
