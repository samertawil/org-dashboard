<div class="flex flex-col gap-6 p-8">
    <div class="flex items-center justify-between">
        ...
        <div class="flex gap-2">
            <flux:button wire:click="downloadPdf" icon="printer" variant="filled" color="indigo" size="sm">
                {{ __('Print PDF') }}
            </flux:button>
            <flux:badge color="indigo">{{ __('Submitted At') }}: {{ $quotation->submitted_at->format('Y-m-d H:i') }}</flux:badge>
        </div>
    </div>
