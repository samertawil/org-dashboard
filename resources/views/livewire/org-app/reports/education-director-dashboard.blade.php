<div class="flex flex-col gap-6" dir="rtl">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 print:hidden" dir="ltr">
        <div class="flex flex-col gap-1 text-left">
            <flux:heading level="1" size="xl" class="font-bold text-zinc-900 dark:text-zinc-100">Education Director Dashboard</flux:heading>
            <flux:subheading class="text-zinc-500 dark:text-zinc-400">Monitor the educational process and key indicators of the center</flux:subheading>
        </div>
    ...
    <!-- Filters Section -->
    <div
        class="bg-white dark:bg-zinc-800 p-6 rounded-xl border border-zinc-200 dark:border-zinc-700 shadow-sm print:hidden" dir="ltr">
