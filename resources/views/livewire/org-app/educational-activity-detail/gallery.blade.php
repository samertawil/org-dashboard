<div class="h-full flex flex-col gap-6" x-data="{
        ...
        <div class="flex flex-col gap-1">
            @if (!$this->isModal)
                <div class="flex items-center gap-2 text-zinc-500">
                    <a href="{{ route('educational-activity-detail.index') }}" wire:navigate
                    ...
                    <span
                        class="text-zinc-900 dark:text-white font-medium">{{ $detail?->educationalActivity?->activity_name }}</span>
                </div>
            @endif
    ...
    <div class="flex-1 flex overflow-hidden gap-6">
        ...
        <div class="flex-1 h-full overflow-y-auto pr-2 pb-10">
            ...
            @else
                <div
                    class="grid grid-cols-3 {{ $this->isModal ? '' : 'md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8' }} gap-3">
                        ...
                        <div wire:key="attachment-{{ $index }}"
                            ...
                            <div
                                ...
                                <a @if ($isImage) href="#" @click.prevent="openCarousel('{{ Storage::url($attachment['path']) }}')" @else href="{{ Storage::url($attachment['path']) }}" target="_blank" @endif
                                    style="width: 170px; height: 150px;" loading="lazy"
        ...
        <div class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <flux:input wire:model="uploadNotes" :label="__('Display Name (Optional)')"
                    placeholder="e.g. Activity Photo" />
            </div>
    ...
    {{-- Carousel Modal --}}
    <flux:modal name="carousel-modal" class="w-full max-w-3xl" variant="bare"
