<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between mb-8">
        <div class="flex flex-col gap-1">
            ...
            <flux:subheading>{{ __('Define a new evaluation range for the survey grading scale.') }}</flux:subheading>
        </div>
    ...
    <div class="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 shadow-sm overflow-hidden p-6">
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="flex justify-end pt-6 border-t border-zinc-100 dark:border-zinc-700">
                <flux:button type="submit" variant="primary" icon="check" class="bg-green-600 hover:bg-green-700 text-white">
                    {{ __('Save Grading Scale') }}
                </flux:button>
            </div>
        </form>
    </div>
