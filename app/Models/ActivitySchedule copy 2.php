...
class ActivitySchedule extends Model
{
    ...
    {
        return $query->pending()->where('period_end', '<', now());
    }

    /**
     * تصفية الأنشطة المطلوبة اليوم (تاريخ البدء أكبر أو يساوي الوقت الحالي وتاريخ نهاية النشاط أكبر من الوقت الحالي لكنه ما زال بنفس اليوم)
     */
    ...
    public function getTaskStatusAttribute(): string
    {
        ...
        if ($this->period_start->greaterThanOrEqualTo($now) && $this->period_end->lessThanOrEqualTo($now->endOfDay())) {
